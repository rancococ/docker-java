...
# run default command
docker run -it --rm --name alpine-java-1.8.181 myharbor.com/base/java:alpine-java-1.8.181
# run sshd
docker run -it --rm --name alpine-java-1.8.181 -p 10022:22 myharbor.com/base/java:alpine-java-1.8.181 ""
# run bash
