...
# run default command
docker run -it --rm --name java-centos-1.8.181 myharbor.com/base/java:centos-1.8.181
# run sshd
docker run -it --rm --name java-centos-1.8.181 -p 10022:22 myharbor.com/base/java:centos-1.8.181 ""
# run bash
